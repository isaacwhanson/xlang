  ...
  public class Scanner : IScanner {
    ...
    Token NextToken() {
      ...
      switch (state) {
        ...
        {t.kind = 44; break;}
        case 114:
          if (ch == 'z') { AddCh(); goto case 115; }
        else {goto case 0;}
        case 115:
        {t.kind = 45; break;}
        case 116:
          if (ch == 'o') { AddCh(); goto case 117; }
        else {goto case 0;}
        case 117:
          if (ch == 'p') { AddCh(); goto case 118; }
        else {goto case 0;}
        case 118:
          if (ch == 'c') { AddCh(); goto case 119; }
        else {goto case 0;}
        case 119:
          if (ch == 'n') { AddCh(); goto case 120; }
        else {goto case 0;}
        case 120:
        ...
        {t.kind = 46; break;}
        case 122:
          if (ch == 'd') { AddCh(); goto case 123; }
        else {goto case 0;}
        case 123:
        {t.kind = 47; break;}
        case 124:
          if (ch == 'b') { AddCh(); goto case 125; }
        else {goto case 0;}
        case 125:
        {t.kind = 48; break;}
        case 126:
          if (ch == 'u') { AddCh(); goto case 127; }
        else {goto case 0;}
        case 127:
          if (ch == 'l') { AddCh(); goto case 128; }
        else {goto case 0;}
        case 128:
        {t.kind = 49; break;}
        case 129:
        ...
        case 147:
          if (ch == 'p') { AddCh(); goto case 148; }
        else {goto case 0;}
        case 148:
          if (ch == '/') { AddCh(); goto case 149; }
        else {goto case 0;}
        case 149:
          if (ch == 'i') { AddCh(); goto case 150; }
        else {goto case 0;}
        case 150:
          if (ch == '6') { AddCh(); goto case 151; }
        else {goto case 0;}
        case 151:
          if (ch == '4') { AddCh(); goto case 152; }
        else {goto case 0;}
        case 152:
        {t.kind = 62; break;}
        case 153:
          if (ch == '2') { AddCh(); goto case 154; }
        else {goto case 0;}
        case 154:
        {t.kind = 63; break;}
        case 155:
          if (ch == '2') { AddCh(); goto case 156; }
        else {goto case 0;}
        case 156:
        {t.kind = 64; break;}
        case 157:
          if (ch == '4') { AddCh(); goto case 158; }
        else {goto case 0;}
        case 158:
        {t.kind = 65; break;}
        case 159:
          if (ch == '4') { AddCh(); goto case 160; }
        else {goto case 0;}
        case 160:
        {t.kind = 66; break;}
        case 161:
        ...
        {t.kind = 77; break;}
        case 172:
          if (ch == 'z') { AddCh(); goto case 173; }
        else {goto case 0;}
        case 173:
        {t.kind = 78; break;}
        case 174:
          if (ch == 'z') { AddCh(); goto case 175; }
        else {goto case 0;}
        case 175:
        {t.kind = 79; break;}
        case 176:
          if (ch == 'o') { AddCh(); goto case 177; }
        else {goto case 0;}
        case 177:
          if (ch == 'p') { AddCh(); goto case 178; }
        else {goto case 0;}
        case 178:
          if (ch == 'c') { AddCh(); goto case 179; }
        else {goto case 0;}
        case 179:
          if (ch == 'n') { AddCh(); goto case 180; }
        else {goto case 0;}
        case 180:
          if (ch == 't') { AddCh(); goto case 181; }
        else {goto case 0;}
        case 181:
        {t.kind = 80; break;}
        case 182:
          if (ch == 'd') { AddCh(); goto case 183; }
        else {goto case 0;}
        case 183:
        {t.kind = 81; break;}
        case 184:
          if (ch == 'b') { AddCh(); goto case 185; }
        else {goto case 0;}
        case 185:
        {t.kind = 82; break;}
        case 186:
          if (ch == 'u') { AddCh(); goto case 187; }
        else {goto case 0;}
        case 187:
        ...
        {t.kind = 89; break;}
        case 197:
          if (ch == 'o') { AddCh(); goto case 198; }
        else {goto case 0;}
        case 198:
          if (ch == 'r') { AddCh(); goto case 199; }
        else {goto case 0;}
        case 199:
        {t.kind = 90; break;}
        case 200:
        ...
        {t.kind = 95; break;}
        case 205:
          if (ch == '/') { AddCh(); goto case 206; }
        else {goto case 0;}
        case 206:
          if (ch == 'i') { AddCh(); goto case 207; }
        else {goto case 0;}
        case 207:
          if (ch == '3') { AddCh(); goto case 208; }
        else {goto case 0;}
        case 208:
          if (ch == '2') { AddCh(); goto case 209; }
        else {goto case 0;}
        case 209:
        {t.kind = 96; break;}
        case 210:
          if (ch == '/') { AddCh(); goto case 211; }
        else {goto case 0;}
        case 211:
          if (ch == 'i') { AddCh(); goto case 212; }
        else {goto case 0;}
        case 212:
          if (ch == '3') { AddCh(); goto case 213; }
        else {goto case 0;}
        case 213:
          if (ch == '2') { AddCh(); goto case 214; }
        else {goto case 0;}
        case 214:
        {t.kind = 97; break;}
        case 215:
          if (ch == '2') { AddCh(); goto case 216; }
        else {goto case 0;}
        case 216:
        {t.kind = 98; break;}
        case 217:
          if (ch == '2') { AddCh(); goto case 218; }
        else {goto case 0;}
        case 218:
        {t.kind = 99; break;}
        case 219:
          if (ch == '4') { AddCh(); goto case 220; }
        else {goto case 0;}
        case 220:
        {t.kind = 100; break;}
        case 221:
          if (ch == '4') { AddCh(); goto case 222; }
        else {goto case 0;}
        case 222:
        {t.kind = 101; break;}
        case 223:
          if (ch == 'q') { AddCh(); goto case 224; }
        else {goto case 0;}
        case 224:
        {t.kind = 102; break;}
        case 225:
        ...
        {t.kind = 109; break;}
        case 232:
          if (ch == 'i') { AddCh(); goto case 233; }
        else {goto case 0;}
        case 233:
          if (ch == 'l') { AddCh(); goto case 234; }
        else {goto case 0;}
        case 234:
        {t.kind = 110; break;}
        case 235:
          if (ch == 'l') { AddCh(); goto case 236; }
        else {goto case 0;}
        case 236:
          if (ch == 'o') { AddCh(); goto case 237; }
        else {goto case 0;}
        case 237:
          if (ch == 'o') { AddCh(); goto case 238; }
        else {goto case 0;}
        case 238:
          if (ch == 'r') { AddCh(); goto case 239; }
        else {goto case 0;}
        case 239:
        {t.kind = 111; break;}
        case 240:
          if (ch == 'r') { AddCh(); goto case 241; }
        else {goto case 0;}
        case 241:
          if (ch == 'u') { AddCh(); goto case 242; }
        else {goto case 0;}
        case 242:
          if (ch == 'n') { AddCh(); goto case 243; }
        else {goto case 0;}
        case 243:
          if (ch == 'c') { AddCh(); goto case 244; }
        else {goto case 0;}
        case 244:
        {t.kind = 112; break;}
        case 245:
          if (ch == 'r') { AddCh(); goto case 246; }
        else {goto case 0;}
        case 246:
          if (ch == 'e') { AddCh(); goto case 247; }
        else {goto case 0;}
        case 247:
          if (ch == 's') { AddCh(); goto case 248; }
        else {goto case 0;}
        case 248:
          if (ch == 't') { AddCh(); goto case 249; }
        else {goto case 0;}
        case 249:
        {t.kind = 113; break;}
        case 250:
          if (ch == 'r') { AddCh(); goto case 251; }
        else {goto case 0;}
        case 251:
          if (ch == 't') { AddCh(); goto case 252; }
        else {goto case 0;}
        case 252:
        {t.kind = 114; break;}
        case 253:
        ...
        {t.kind = 115; break;}
        case 255:
          if (ch == 'b') { AddCh(); goto case 256; }
        else {goto case 0;}
        case 256:
        {t.kind = 116; break;}
        case 257:
          if (ch == 'l') { AddCh(); goto case 258; }
        else {goto case 0;}
        case 258:
        {t.kind = 117; break;}
        case 259:
          if (ch == 'v') { AddCh(); goto case 260; }
        else {goto case 0;}
        case 260:
        {t.kind = 118; break;}
        case 261:
          if (ch == 'n') { AddCh(); goto case 262; }
        else {goto case 0;}
        case 262:
        {t.kind = 119; break;}
        case 263:
          if (ch == 'x') { AddCh(); goto case 264; }
        else {goto case 0;}
        case 264:
        {t.kind = 120; break;}
        case 265:
          if (ch == 'y') { AddCh(); goto case 266; }
        else {goto case 0;}
        case 266:
          if (ch == 's') { AddCh(); goto case 267; }
        else {goto case 0;}
        case 267:
          if (ch == 'i') { AddCh(); goto case 268; }
        else {goto case 0;}
        case 268:
          if (ch == 'g') { AddCh(); goto case 269; }
        else {goto case 0;}
        case 269:
          if (ch == 'n') { AddCh(); goto case 270; }
        else {goto case 0;}
        case 270:
        {t.kind = 121; break;}
        case 271:
          if (ch == '2') { AddCh(); goto case 272; }
        else {goto case 0;}
        case 272:
        {t.kind = 122; break;}
        case 273:
          if (ch == '2') { AddCh(); goto case 274; }
        else {goto case 0;}
        case 274:
        {t.kind = 123; break;}
        case 275:
          if (ch == '4') { AddCh(); goto case 276; }
        else {goto case 0;}
        case 276:
        {t.kind = 124; break;}
        case 277:
          if (ch == '4') { AddCh(); goto case 278; }
        else {goto case 0;}
        case 278:
        {t.kind = 125; break;}
        case 279:
          if (ch == 'm') { AddCh(); goto case 280; }
        else {goto case 0;}
        case 280:
          if (ch == 'o') { AddCh(); goto case 281; }
        else {goto case 0;}
        case 281:
          if (ch == 't') { AddCh(); goto case 282; }
        else {goto case 0;}
        case 282:
          if (ch == 'e') { AddCh(); goto case 283; }
        else {goto case 0;}
        case 283:
          if (ch == '/') { AddCh(); goto case 284; }
        else {goto case 0;}
        case 284:
          if (ch == 'f') { AddCh(); goto case 285; }
        else {goto case 0;}
        case 285:
          if (ch == '6') { AddCh(); goto case 286; }
        else {goto case 0;}
        case 286:
          if (ch == '4') { AddCh(); goto case 287; }
        else {goto case 0;}
        case 287:
        {t.kind = 126; break;}
        case 288:
          if (ch == 'q') { AddCh(); goto case 289; }
        else {goto case 0;}
        case 289:
        {t.kind = 127; break;}
        case 290:
        ...
        {t.kind = 134; break;}
        case 297:
          if (ch == 'i') { AddCh(); goto case 298; }
        else {goto case 0;}
        case 298:
          if (ch == 'l') { AddCh(); goto case 299; }
        else {goto case 0;}
        case 299:
        {t.kind = 135; break;}
        case 300:
          if (ch == 'l') { AddCh(); goto case 301; }
        else {goto case 0;}
        case 301:
          if (ch == 'o') { AddCh(); goto case 302; }
        else {goto case 0;}
        case 302:
          if (ch == 'o') { AddCh(); goto case 303; }
        else {goto case 0;}
        case 303:
          if (ch == 'r') { AddCh(); goto case 304; }
        else {goto case 0;}
        case 304:
        {t.kind = 136; break;}
        case 305:
          if (ch == 'r') { AddCh(); goto case 306; }
        else {goto case 0;}
        case 306:
          if (ch == 'u') { AddCh(); goto case 307; }
        else {goto case 0;}
        case 307:
          if (ch == 'n') { AddCh(); goto case 308; }
        else {goto case 0;}
        case 308:
          if (ch == 'c') { AddCh(); goto case 309; }
        else {goto case 0;}
        case 309:
        {t.kind = 137; break;}
        case 310:
          if (ch == 'r') { AddCh(); goto case 311; }
        else {goto case 0;}
        case 311:
          if (ch == 'e') { AddCh(); goto case 312; }
        else {goto case 0;}
        case 312:
          if (ch == 's') { AddCh(); goto case 313; }
        else {goto case 0;}
        case 313:
          if (ch == 't') { AddCh(); goto case 314; }
        else {goto case 0;}
        case 314:
        {t.kind = 138; break;}
        case 315:
          if (ch == 'r') { AddCh(); goto case 316; }
        else {goto case 0;}
        case 316:
          if (ch == 't') { AddCh(); goto case 317; }
        else {goto case 0;}
        case 317:
        {t.kind = 139; break;}
        case 318:
          if (ch == 'd') { AddCh(); goto case 319; }
        else {goto case 0;}
        case 319:
        {t.kind = 140; break;}
        case 320:
          if (ch == 'b') { AddCh(); goto case 321; }
        else {goto case 0;}
        case 321:
        {t.kind = 141; break;}
        case 322:
          if (ch == 'l') { AddCh(); goto case 323; }
        else {goto case 0;}
        case 323:
        {t.kind = 142; break;}
        case 324:
          if (ch == 'i') { AddCh(); goto case 325; }
        else {goto case 0;}
        case 325:
          if (ch == 'v') { AddCh(); goto case 326; }
        else {goto case 0;}
        case 326:
        {t.kind = 143; break;}
        case 327:
          if (ch == 'n') { AddCh(); goto case 328; }
        else {goto case 0;}
        case 328:
        {t.kind = 144; break;}
        case 329:
          if (ch == 'x') { AddCh(); goto case 330; }
        else {goto case 0;}
        case 330:
        {t.kind = 145; break;}
        case 331:
          if (ch == 'y') { AddCh(); goto case 332; }
        else {goto case 0;}
        case 332:
          if (ch == 's') { AddCh(); goto case 333; }
        else {goto case 0;}
        case 333:
          if (ch == 'i') { AddCh(); goto case 334; }
        else {goto case 0;}
        case 334:
          if (ch == 'g') { AddCh(); goto case 335; }
        else {goto case 0;}
        case 335:
          if (ch == 'n') { AddCh(); goto case 336; }
        else {goto case 0;}
        case 336:
        {t.kind = 146; break;}
        case 337:
        ...
        case 521:
          ...
          else if (ch == 'g') { AddCh(); goto case 529; }
          else if (ch == 'c') { AddCh(); goto case 530; }
          else if (ch == 'p') { AddCh(); goto case 116; }
          else if (ch == 'a') { AddCh(); goto case 531; }
          else if (ch == 's') { AddCh(); goto case 532; }
          else if (ch == 'm') { AddCh(); goto case 126; }
          else if (ch == 'd') { AddCh(); goto case 533; }
          else if (ch == 'r') { AddCh(); goto case 534; }
          else if (ch == 'o') { AddCh(); goto case 135; }
          else if (ch == 'x') { AddCh(); goto case 137; }
        ...
        case 522:
          ...
          else if (ch == 'g') { AddCh(); goto case 538; }
          else if (ch == 'c') { AddCh(); goto case 539; }
          else if (ch == 'p') { AddCh(); goto case 176; }
          else if (ch == 'a') { AddCh(); goto case 540; }
          else if (ch == 's') { AddCh(); goto case 541; }
          else if (ch == 'm') { AddCh(); goto case 186; }
          else if (ch == 'd') { AddCh(); goto case 542; }
          else if (ch == 'r') { AddCh(); goto case 543; }
          else if (ch == 'o') { AddCh(); goto case 195; }
        ...
        case 523:
          ...
          else if (ch == 'g') { AddCh(); goto case 547; }
          else if (ch == 'a') { AddCh(); goto case 548; }
          else if (ch == 'c') { AddCh(); goto case 549; }
          else if (ch == 'f') { AddCh(); goto case 235; }
          else if (ch == 't') { AddCh(); goto case 240; }
          else if (ch == 's') { AddCh(); goto case 550; }
          else if (ch == 'm') { AddCh(); goto case 551; }
        ...
        case 524:
          ...
          else if (ch == 'g') { AddCh(); goto case 555; }
          else if (ch == 'a') { AddCh(); goto case 556; }
          else if (ch == 'c') { AddCh(); goto case 557; }
          else if (ch == 'f') { AddCh(); goto case 300; }
          else if (ch == 't') { AddCh(); goto case 305; }
          else if (ch == 's') { AddCh(); goto case 558; }
          else if (ch == 'm') { AddCh(); goto case 559; }
          else if (ch == 'd') { AddCh(); goto case 324; }
        ...
        case 528:
          if (ch == 't') { AddCh(); goto case 561; }
          else if (ch == 'e') { AddCh(); goto case 562; }
          else if (ch == 'o') { AddCh(); goto case 563; }
        else {goto case 0;}
        case 529:
          if (ch == 't') { AddCh(); goto case 564; }
          else if (ch == 'e') { AddCh(); goto case 565; }
        else {goto case 0;}
        case 530:
          if (ch == 'l') { AddCh(); goto case 112; }
          else if (ch == 't') { AddCh(); goto case 114; }
        else {goto case 0;}
        case 531:
          if (ch == 'd') { AddCh(); goto case 122; }
          else if (ch == 'n') { AddCh(); goto case 133; }
        else {goto case 0;}
        case 532:
          if (ch == 'u') { AddCh(); goto case 124; }
          else if (ch == 'h') { AddCh(); goto case 566; }
          else if (ch == 't') { AddCh(); goto case 567; }
        else {goto case 0;}
        case 533:
          if (ch == 'i') { AddCh(); goto case 568; }
        else {goto case 0;}
        case 534:
          if (ch == 'e') { AddCh(); goto case 569; }
          else if (ch == 'o') { AddCh(); goto case 570; }
        else {goto case 0;}
        case 535:
          if (ch == 'r') { AddCh(); goto case 571; }
        else {goto case 0;}
        case 536:
          if (ch == 'q') { AddCh(); goto case 572; }
          else if (ch == 'x') { AddCh(); goto case 573; }
        else {goto case 0;}
        case 537:
          if (ch == 't') { AddCh(); goto case 574; }
          else if (ch == 'e') { AddCh(); goto case 575; }
          else if (ch == 'o') { AddCh(); goto case 576; }
        else {goto case 0;}
        case 538:
          if (ch == 't') { AddCh(); goto case 577; }
          else if (ch == 'e') { AddCh(); goto case 578; }
        else {goto case 0;}
        case 539:
          if (ch == 'l') { AddCh(); goto case 172; }
          else if (ch == 't') { AddCh(); goto case 174; }
        else {goto case 0;}
        case 540:
          if (ch == 'd') { AddCh(); goto case 182; }
          else if (ch == 'n') { AddCh(); goto case 193; }
        else {goto case 0;}
        case 541:
          if (ch == 'u') { AddCh(); goto case 184; }
          else if (ch == 'h') { AddCh(); goto case 579; }
          else if (ch == 't') { AddCh(); goto case 580; }
        else {goto case 0;}
        case 542:
          if (ch == 'i') { AddCh(); goto case 581; }
        else {goto case 0;}
        case 543:
        ...
        case 544:
          if (ch == 'r') { AddCh(); goto case 584; }
        else {goto case 0;}
        case 545:
          if (ch == 'e') { AddCh(); goto case 585; }
        else {goto case 0;}
        case 546:
        ...
        case 547:
          ...
          else if (ch == 'e') { AddCh(); goto case 228; }
        else {goto case 0;}
        case 548:
          if (ch == 'b') { AddCh(); goto case 229; }
          else if (ch == 'd') { AddCh(); goto case 253; }
        else {goto case 0;}
        case 549:
          if (ch == 'e') { AddCh(); goto case 232; }
          else if (ch == 'o') { AddCh(); goto case 586; }
        else {goto case 0;}
        case 550:
        ...
        case 551:
          ...
          else if (ch == 'i') { AddCh(); goto case 261; }
          else if (ch == 'a') { AddCh(); goto case 263; }
        else {goto case 0;}
        case 552:
          if (ch == 'i') { AddCh(); goto case 259; }
          else if (ch == 'e') { AddCh(); goto case 279; }
        else {goto case 0;}
        case 553:
          if (ch == 'e') { AddCh(); goto case 587; }
        else {goto case 0;}
        case 554:
        ...
        case 555:
          ...
          else if (ch == 'e') { AddCh(); goto case 293; }
        else {goto case 0;}
        case 556:
          if (ch == 'b') { AddCh(); goto case 294; }
          else if (ch == 'd') { AddCh(); goto case 318; }
        else {goto case 0;}
        case 557:
          if (ch == 'e') { AddCh(); goto case 297; }
          else if (ch == 'o') { AddCh(); goto case 588; }
        else {goto case 0;}
        case 558:
        ...
        case 559:
          ...
          else if (ch == 'i') { AddCh(); goto case 327; }
          else if (ch == 'a') { AddCh(); goto case 329; }
        else {goto case 0;}
        case 560:
        ...
        case 561:
          if (ch == '_') { AddCh(); goto case 589; }
        else {goto case 0;}
        case 562:
          if (ch == '_') { AddCh(); goto case 590; }
        else {goto case 0;}
        case 563:
          if (ch == 'a') { AddCh(); goto case 591; }
        else {goto case 0;}
        case 564:
          if (ch == '_') { AddCh(); goto case 592; }
        else {goto case 0;}
        case 565:
          if (ch == '_') { AddCh(); goto case 593; }
        else {goto case 0;}
        case 566:
          if (ch == 'l') { AddCh(); goto case 140; }
          else if (ch == 'r') { AddCh(); goto case 594; }
        else {goto case 0;}
        case 567:
          if (ch == 'o') { AddCh(); goto case 595; }
        else {goto case 0;}
        case 568:
          if (ch == 'v') { AddCh(); goto case 596; }
        else {goto case 0;}
        case 569:
          if (ch == 'm') { AddCh(); goto case 597; }
          else if (ch == 'i') { AddCh(); goto case 356; }
        else {goto case 0;}
        case 570:
          if (ch == 't') { AddCh(); goto case 598; }
        else {goto case 0;}
        case 571:
          if (ch == 'u') { AddCh(); goto case 599; }
        else {goto case 0;}
        case 572:
          recEnd = pos; recKind = 68;
          if (ch == 'z') { AddCh(); goto case 161; }
        else {t.kind = 68; break;}
        case 573:
          if (ch == 't') { AddCh(); goto case 600; }
        else {goto case 0;}
        case 574:
          if (ch == '_') { AddCh(); goto case 601; }
        else {goto case 0;}
        case 575:
          if (ch == '_') { AddCh(); goto case 602; }
        else {goto case 0;}
        case 576:
          if (ch == 'a') { AddCh(); goto case 603; }
        else {goto case 0;}
        case 577:
          if (ch == '_') { AddCh(); goto case 604; }
        else {goto case 0;}
        case 578:
          if (ch == '_') { AddCh(); goto case 605; }
        else {goto case 0;}
        case 579:
          if (ch == 'l') { AddCh(); goto case 200; }
          else if (ch == 'r') { AddCh(); goto case 606; }
        else {goto case 0;}
        case 580:
          if (ch == 'o') { AddCh(); goto case 607; }
        else {goto case 0;}
        case 581:
          if (ch == 'v') { AddCh(); goto case 608; }
        else {goto case 0;}
        case 582:
          if (ch == 'm') { AddCh(); goto case 609; }
          else if (ch == 'i') { AddCh(); goto case 369; }
        else {goto case 0;}
        case 583:
          if (ch == 't') { AddCh(); goto case 610; }
        else {goto case 0;}
        case 584:
          if (ch == 'u') { AddCh(); goto case 611; }
        else {goto case 0;}
        case 585:
          recEnd = pos; recKind = 103;
          if (ch == 'g') { AddCh(); goto case 231; }
          else if (ch == 'a') { AddCh(); goto case 245; }
        else {t.kind = 103; break;}
        case 586:
          if (ch == 'p') { AddCh(); goto case 265; }
          else if (ch == 'n') { AddCh(); goto case 612; }
        else {goto case 0;}
        case 587:
          recEnd = pos; recKind = 128;
          if (ch == 'g') { AddCh(); goto case 296; }
          else if (ch == 'a') { AddCh(); goto case 310; }
        else {t.kind = 128; break;}
        case 588:
          if (ch == 'p') { AddCh(); goto case 331; }
          else if (ch == 'n') { AddCh(); goto case 613; }
        else {goto case 0;}
        case 589:
        ...
        case 594:
          if (ch == '_') { AddCh(); goto case 615; }
        else {goto case 0;}
        case 595:
          if (ch == 'r') { AddCh(); goto case 616; }
        else {goto case 0;}
        case 596:
          if (ch == '_') { AddCh(); goto case 617; }
        else {goto case 0;}
        case 597:
          if (ch == '_') { AddCh(); goto case 618; }
        else {goto case 0;}
        case 598:
          if (ch == 'l') { AddCh(); goto case 143; }
          else if (ch == 'r') { AddCh(); goto case 144; }
        else {goto case 0;}
        case 599:
          if (ch == 'n') { AddCh(); goto case 619; }
        else {goto case 0;}
        case 600:
          if (ch == 'e') { AddCh(); goto case 620; }
        else {goto case 0;}
        case 601:
          if (ch == 'u') { AddCh(); goto case 164; }
          else if (ch == 's') { AddCh(); goto case 165; }
        else {goto case 0;}
        case 602:
          if (ch == 'u') { AddCh(); goto case 168; }
          else if (ch == 's') { AddCh(); goto case 169; }
        else {goto case 0;}
        case 603:
          if (ch == 'd') { AddCh(); goto case 621; }
        else {goto case 0;}
        case 604:
          if (ch == 'u') { AddCh(); goto case 166; }
          else if (ch == 's') { AddCh(); goto case 167; }
        else {goto case 0;}
        case 605:
          if (ch == 'u') { AddCh(); goto case 170; }
          else if (ch == 's') { AddCh(); goto case 171; }
        else {goto case 0;}
        case 606:
        ...
        case 610:
          if (ch == 'l') { AddCh(); goto case 203; }
          else if (ch == 'r') { AddCh(); goto case 204; }
        else {goto case 0;}
        case 611:
          if (ch == 'n') { AddCh(); goto case 626; }
        else {goto case 0;}
        case 612:
          if (ch == 'v') { AddCh(); goto case 627; }
        else {goto case 0;}
        case 613:
        ...
        case 616:
          if (ch == 'e') { AddCh(); goto case 631; }
        else {goto case 0;}
        case 617:
          if (ch == 's') { AddCh(); goto case 129; }
          else if (ch == 'u') { AddCh(); goto case 130; }
        else {goto case 0;}
        case 618:
          if (ch == 's') { AddCh(); goto case 131; }
          else if (ch == 'u') { AddCh(); goto case 132; }
        else {goto case 0;}
        case 619:
          if (ch == 'c') { AddCh(); goto case 632; }
        else {goto case 0;}
        case 620:
        ...
        case 623:
          if (ch == 'e') { AddCh(); goto case 637; }
        else {goto case 0;}
        case 624:
          if (ch == 's') { AddCh(); goto case 189; }
          else if (ch == 'u') { AddCh(); goto case 190; }
        else {goto case 0;}
        case 625:
          if (ch == 's') { AddCh(); goto case 191; }
          else if (ch == 'u') { AddCh(); goto case 192; }
        else {goto case 0;}
        case 626:
          if (ch == 'c') { AddCh(); goto case 638; }
        else {goto case 0;}
        case 627:
          if (ch == 'e') { AddCh(); goto case 639; }
        else {goto case 0;}
        case 628:
          if (ch == 'e') { AddCh(); goto case 640; }
        else {goto case 0;}
        case 629:
          if (ch == '_') { AddCh(); goto case 641; }
        else {goto case 0;}
        case 630:
        ...
        case 633:
          if (ch == 'd') { AddCh(); goto case 644; }
        else {goto case 0;}
        case 634:
          if (ch == '_') { AddCh(); goto case 645; }
        else {goto case 0;}
        case 635:
          if (ch == '6') { AddCh(); goto case 646; }
        else {goto case 0;}
        case 636:
        ...
        case 647:
          if (ch == '_') { AddCh(); goto case 656; }
        else {goto case 0;}
        case 648:
          if (ch == 's') { AddCh(); goto case 657; }
          else if (ch == 'u') { AddCh(); goto case 658; }
        else {goto case 0;}
        case 649:
          if (ch == 't') { AddCh(); goto case 659; }
        else {goto case 0;}
        case 650:
        ...
        case 653:
          if (ch == '/') { AddCh(); goto case 662; }
        else {goto case 0;}
        case 654:
          if (ch == 's') { AddCh(); goto case 205; }
        ...
        case 658:
          if (ch == '/') { AddCh(); goto case 664; }
        else {goto case 0;}
        case 659:
          if (ch == '_') { AddCh(); goto case 665; }
        else {goto case 0;}
        case 660:
          if (ch == '_') { AddCh(); goto case 666; }
        else {goto case 0;}
        case 661:
          if (ch == 'f') { AddCh(); goto case 667; }
        else {goto case 0;}
        case 662:
          if (ch == 'f') { AddCh(); goto case 668; }
        else {goto case 0;}
        case 663:
          if (ch == 'f') { AddCh(); goto case 669; }
        else {goto case 0;}
        case 664:
          if (ch == 'f') { AddCh(); goto case 670; }
        else {goto case 0;}
        case 665:
          if (ch == 's') { AddCh(); goto case 671; }
          else if (ch == 'u') { AddCh(); goto case 672; }
        else {goto case 0;}
        case 666:
          if (ch == 's') { AddCh(); goto case 673; }
          else if (ch == 'u') { AddCh(); goto case 674; }
        else {goto case 0;}
        case 667:
          if (ch == '3') { AddCh(); goto case 153; }
          else if (ch == '6') { AddCh(); goto case 157; }
        else {goto case 0;}
        case 668:
          if (ch == '3') { AddCh(); goto case 155; }
          else if (ch == '6') { AddCh(); goto case 159; }
        else {goto case 0;}
        case 669:
          if (ch == '3') { AddCh(); goto case 215; }
          else if (ch == '6') { AddCh(); goto case 219; }
        else {goto case 0;}
        case 670:
          if (ch == '3') { AddCh(); goto case 217; }
          else if (ch == '6') { AddCh(); goto case 221; }
        else {goto case 0;}
        case 671:
          if (ch == '/') { AddCh(); goto case 675; }
        else {goto case 0;}
        case 672:
          if (ch == '/') { AddCh(); goto case 676; }
        else {goto case 0;}
        case 673:
          if (ch == '/') { AddCh(); goto case 677; }
        else {goto case 0;}
        case 674:
          if (ch == '/') { AddCh(); goto case 678; }
        else {goto case 0;}
        case 675:
          if (ch == 'i') { AddCh(); goto case 679; }
        else {goto case 0;}
        case 676:
          if (ch == 'i') { AddCh(); goto case 680; }
        else {goto case 0;}
        case 677:
          if (ch == 'i') { AddCh(); goto case 681; }
        else {goto case 0;}
        case 678:
          if (ch == 'i') { AddCh(); goto case 682; }
        else {goto case 0;}
        case 679:
          if (ch == '3') { AddCh(); goto case 271; }
          else if (ch == '6') { AddCh(); goto case 275; }
        else {goto case 0;}
        case 680:
          if (ch == '3') { AddCh(); goto case 273; }
          else if (ch == '6') { AddCh(); goto case 277; }
        else {goto case 0;}
        case 681:
